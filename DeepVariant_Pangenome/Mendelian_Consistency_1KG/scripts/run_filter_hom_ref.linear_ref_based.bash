...
N_PARALLEL=4
THREADS=4
WORKING_DIR="/private/groups/patenlab/masri/haplotype_sampling/pangenome_aware_dv_paper/1KG_Trio_analysis/linear_ref_based_dv"

cd "${WORKING_DIR}"

SAMPLES=$(cat ../selected_trio_samples.txt)
...
create_vcf_for_chrom() {
  ...
  local out="chr${chrom}.1kg_cohort.vg.linear_ref_based_dv.grch38.20_trios.with_non_ref_allele.vcf.gz"
